...
auto Compositor::GetPosition(Visual handle) -> Vec2 { return {}; }
auto Compositor::GetSize(Visual handle) -> Vec2 { return {}; }
auto Compositor::GetScale(Visual handle) -> Vec2 { return {}; }
auto Compositor::GetRotation(Visual handle) -> float { return {}; }
